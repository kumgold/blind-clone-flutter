...
자주 사용하는 블라인드 서비스를 클론 코딩 하였습니다. Firebase Realtime Database를 활용해서 게시글, 스토리 등을 CRUD가 가능하도록 구현하였습니다.
커뮤니티 서비스를 이해하기 위해 블라인드를 선택하였습니다. 또한, 사용자가 아닌 개발자로써 실제 서비스에 대한 이해도를 높이기 위해 클론 프로젝트를 개발하였습니다.
